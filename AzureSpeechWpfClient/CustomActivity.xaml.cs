...
namespace AzureSpeechWpfClient
{
    ...
    /// </summary>
    public partial class CustomActivity : Window
    {
        // Binding for the combobox
        private readonly ObservableCollection<CustomActivityJsonDataEntry> customPayloadDataCollection;

        public CustomActivity(
            ObservableCollection<CustomActivityJsonDataEntry> activityCollection,
            int selectedEntry)
        {
            InitializeComponent();
        ...
        private void SaveActivityButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                    ...
                    !string.IsNullOrWhiteSpace(this.CustomActivityContent))
                {
                    ...
                    {
                        activityInfoEntry = new CustomActivityJsonDataEntry()
                        {
